  ...
  <div class="MessagePop">
    ...
    <div class="pop_bg" v-if="popBgState == true && popData.popBgText == 'modifiedData'">
      <div class="personnel">
        ...
        <div class="btns">
          <span v-if="btnsOn" @click="editDataUrlfn">确认修改</span>
          <span v-else>正在提交请稍后</span>
          <a @click="popBgStateHideFn">取消</a>
        </div>
      </div>
    ...
    <div class="pop_bg" v-if="popBgState == true && popData.popBgText == 'changePassword'">
      <div class="personnel">
        ...
        <div class="btns">
          <span v-if="btnsOn" @click="editPasswordFn">确定修改</span>
          <span v-else>正在提交请稍后</span>
          <a @click="popBgStateHideFn">取消</a>
        </div>
      </div>
        ...
        <div class="user_option">
          <ul class="user_option_ul">
            ...
            <li class="user_option_li">
              <p>
                <span>
                  <i>*</i>{{$store.getters.roleName.adviser}}
                </span>
                <Select :placeholder="`请选择${$store.getters.roleName.adviser}`" v-model="makeAnAppointment.counselorId">
                  <Option
