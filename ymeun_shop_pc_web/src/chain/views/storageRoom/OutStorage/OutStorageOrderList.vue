...
<template>
    ...
    <div class="pal24 par24 pat20 pab20">
        <div class="bg-white pal20 par20">
            <p class="fc-gray4 f14px h40px lh40px">出库制单</p>
                ...
                <el-form ref="form" :inline="true" :rules="rules" :model="form">
                    ...
                    <el-form-item label="领用人" prop="receive_users_id">
                        <el-select placeholder="请选择" v-model="form.receive_users_id" :disabled="disabledInput">
                            <el-option v-for="item in $store.getters.exploit" :key="item.users_id" :label="item.name"
                                       :value="item.users_id"></el-option>
                        </el-select>
                    </el-form-item>

                    <el-form-item label="客户" prop="customer_id">
                        <auto-search-client @changed="myChanged" ref="autoClient" disabled></auto-search-client>
                    </el-form-item>

                    <el-form-item label="项目">
                        <el-select v-model="form.itemsParentId" placeholder="请选择项目" disabled clearable @change="form.itemsId = ''">
                    ...
                    <el-form-item  prop="sid" v-if="form.itemsParentId" label-width="0">
                        <el-select v-model="form.itemsId" placeholder="请选择下级项目" disabled clearable>
...
<script>
    ...
    import {outboundAdd} from '@/chain/assets/api/outStorage/outStorage'
