            ...
            <div class="pal24 par24 pat20 pab20">
                ...
                <div class="bg-white pal20 par20">
                    ...
                    <div class="wb100 f14px">
                        ...
                        <span class="fl bd-gray bd-b1 mar10">{{dataInfo.shortage.store.name}}</span>
                    </div>
                ...
                <div class="pal20 par20 bg-white">
                    ...
                    <template v-if="status == 1">
                        <el-button class="fr minW100" @click="back">返回</el-button>
                    </template>
                    <template v-else-if="status == 2">
                        ...
                        <template v-else>
                            <el-button type="primary" class="fr minW100" @click="send">发货</el-button>
                        </template>
                        <el-button class="fr mal20 mar20 minW100" @click="back">返回</el-button>
                    </template>
...
<script>
    ...
    import { shortageAdd, getShortageDetails, setShortageDelivery } from '@/chain/assets/api/pleaseGoods/pleaseGoods'
    ...
    export default {
        ...
        methods: {
            ...
            send(){
                this.disabled = true
                setShortageDelivery({shortage_id: this.shortage_id,}).then(res=>{
