...
<!--                        <auto-search-client @changed="myChanged" ref='autoSearch'></auto-search-client>-->
                ...
                <div class="pa20 bg-blue5 text-center bd-blue4 bd-a1 f16px">
                    ...
                    <div class="wb15 fl">
                        <p class="fc-gray3 h20px lh20px">总销耗业绩（元）</p>
                        <div class="clear2"></div>
                ...
                <base-list ref="demoTable" :condition="condition"
                    ...
                    <el-table slot="list" :data="demoList" stripe border>
                        ...
                        <el-table-column prop="store_time" align="center" label="销耗业绩(元)" width="200px">
                            <template slot-scope="scope">
                                <template v-for="(item,index) in scope.row.items">
                        ...
                        <el-table-column prop="store_time" align="center" label="总销耗业绩(元)" width="150px">
...
<script>
import { consumeSurplus } from "@/assets/api/shopData/shopData";
