...
export const computedMapDict = function () {
    return {
        ...
        _dictMarketingType: () => [...marketingType],
        ...
        _dictSpareCustomerTow: () => [...spareCustomerTow],
...
export const filtersMapDict = function () {
    return {
        ...
        _filterSpareCustomerTow: (key) => spareCustomerTow.get(key),
 ...
 * @type {Map<any, any>}
 */
export const marketingType = new Map([
    ['0', '全部状态'],
    ['1', '预约'],
    ['2', '已预约'],
    ['3', '取消预约'],
 ...
 * @type {Map<any, any>}
 */
export const spareCustomerTow = new Map([
    ['0', '全部类别'],
    ['1', '老客'],
    ['2', '新客'],
])
