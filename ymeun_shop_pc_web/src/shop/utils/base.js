export default {
  ...
  getStoreHost(type){
    ...
    if(window.location.protocol == 'https:'){
      return 'https://operate.ymeun.com'
    }
    if(type == 'store'){
      return 'http://120.76.244.240:1020'
    }else if(type == 'dev'){
      return 'http://120.76.244.240:1001'
    }
  ...
  getChainHost(type){
    if(window.location.protocol == 'https:'){
      return 'https://passport.ymeun.com'
    }
    if(type == 'store'){
      return 'http://120.76.244.240:1021'
    }else if(type == 'dev'){
      return 'http://120.76.244.240:1003'
    }
  ...
  getDateScope(index) {
    ...
    if (index == 0) {
      ...
      //本月-不带天
      startTime = this.dateTimeToDate(`${date.getFullYear()}-${date.getMonth() +1}-01 00:00:00`,"cycle")
    }else if (index == 6) {
      // 上月不带天
      startTime = this.dateTimeToDate(`${date.getFullYear()}-${date.getMonth()}-01 00:00:00`,'cycle')
      // endTime = this.dateTimeToDate(`${date.getFullYear()}-${date.getMonth()}-${date.getDate()} 23:59:59`,'cycle')
    }else if (index == 7) {
      // 今日
      startTime = this.dateTimeToDate(`${date.getFullYear()}-${date.getMonth() +1}-${date.getDate()}`)
    }
