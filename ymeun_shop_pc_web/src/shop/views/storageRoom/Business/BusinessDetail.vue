...
<!--                    status -->
                    ...
                    <div class="wb50 fl">
                        <el-form-item label="供应商" prop="fullname">
                            <el-input v-model="form.fullname" placeholder="请输入供应商名称"></el-input>
                        </el-form-item>
                    </div>

                    <div class="wb50 fl">
                        <el-form-item label="供应商简称" prop="title">
                            <el-input v-model="form.title" placeholder="请输入供应商简称"></el-input>
                        </el-form-item>
                    </div>

                    <div class="wb50 fl">
                        <el-form-item label="地区" prop="province_regions_id">
                            <el-select v-model="form.province_regions_id" placeholder="请选择地区" readonly="" clearable class="wb33 fl" @change="regionsChange('province', form.province_regions_id)">
                                <el-option v-for="item in provinceList" :key="item.id" :label="item.name" :value="item.id"></el-option>
                            </el-select>
                            <el-select v-model="form.city_regions_id" placeholder="请选择地区" readonly="" clearable class="wb33 fl" @change="regionsChange('city', form.city_regions_id)">
                                <el-option v-for="item in cityList" :key="item.id" :label="item.name" :value="item.id"></el-option>
                            </el-select>
                            <el-select v-model="form.county_regions_id" placeholder="请选择地区" readonly="" clearable class="wb33 fl">
                    ...
                    <div class="wb50 fl">
                        <el-form-item label="联系人" prop="link_man">
                            <el-input v-model="form.link_man" placeholder="请输入联系人"></el-input>
                        </el-form-item>
                    </div>
                    ...
                    <div class="wb100 fl">
                        <el-form-item label="备注">
                            <el-input type="textarea" v-model="form.remarks" :style="'width:'+myWidth+'px'"></el-input>
                        </el-form-item>
                    </div>
                ...
                <div class="wb100 text-center">
                    ...
                    <template v-else>
                        <el-button type="primary" @click="submit"> {{isEdit ? '保存' : '新增供应商'}} </el-button>
                    </template>
                </div>
...
<script>
    ...
    import { businessAdd, businessGetInfo, businessEdit } from '@/shop/assets/api/business/business'
