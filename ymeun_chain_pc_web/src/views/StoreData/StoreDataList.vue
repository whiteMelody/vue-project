<template>
  ...
  <div class="wb100">
    <div class="ShopDeduct">
      <div class="ShopDeduct_box">
        ...
        >
            <el-table slot="list" :data="demoList" stripe border>
                ...
                <el-table-column prop="channel" align="center" label="销售业绩">
                    <template slot-scope="scope">{{ scope.row.order | _filterNumFormat }}</template>
                </el-table-column>

                <el-table-column prop="channel" align="center" label="划扣业绩">
...
import { getConsumeData , storeOpenOrClose } from "@/assets/api/StoreData/StoreData";
