...
<template>
    ...
    <div class="pal24 par24 pat20 pab20">
        <div class="bg-white pal20 par20">
            <p class="fc-gray4 f14px h40px lh40px">出库列表</p>
            ...
            <el-form :inline="true" :model="condition">
                ...
                <el-form-item>
                    <auto-search-client @changed="myChanged" :placeholderText="'请输入客户姓名'"></auto-search-client>
                </el-form-item>

                <el-form-item>
                    <auto-search-client @changed="myChanged2" :placeholderText="'请输入客户电话'"></auto-search-client>
                </el-form-item>
            ...
            <base-list :condition="condition" ref="myList"
                ...
                <el-table slot="list" :data="demoList" border>
                    ...
                    <el-table-column align="left" label="单据日期" width="150px">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="left" label="操作" width="120px">
                        <template slot-scope="scope">
                            <span class="fc-blue pointer" @click="$router.push({ path: 'outStorageOrderDetail', query:{ id: scope.row.id } })">查看详情</span>
                        </template>
                    </el-table-column>
