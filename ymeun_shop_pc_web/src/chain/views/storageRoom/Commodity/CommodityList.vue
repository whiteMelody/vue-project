...
<template>
    ...
    <div class="pal24 par24 pat20 pab20">
        <div class="bg-white pal20 par20">
            <p class="fc-gray4 f14px h40px lh40px">商品列表</p>
            ...
            <div class="wb100">
                ...
                <base-list :condition="condition" ref="myList"
                    ...
                    <el-table slot="list" :data="demoList" border>
                        ...
                        <el-table-column align="left" label="商品编码" width="100px">
                            <template slot-scope="scope">
                                {{scope.row.code}}
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column align="left" label="商品存量">
                            <template slot-scope="scope">
                        ...
                        <el-table-column align="left" label="商品状态" width="100px">
                            <template slot-scope="scope">
                        ...
                        <el-table-column align="left" label="预警状态" width="100px">
                            <template slot-scope="scope">
                        ...
                        <el-table-column align="left" label="操作" width="120px">
                            <template slot-scope="scope">
                                <span class="fc-green2 pointer" @click="$router.push({ path: 'InStorageOne', query:{ row: JSON.stringify(scope.row) } })">入库</span>
                                <span class="fc-gray mal10 mar10">|</span>
                                <span class="fc-green2 pointer" @click="$router.push({ path: 'OutStorageOne', query:{ row: JSON.stringify(scope.row) } })">出库</span>
                            </template>
                        </el-table-column>

                        <el-table-column align="left" label="查看记录" width="160px">
                            <template slot-scope="scope">
                                <span class="fc-green2 pointer" @click="$router.push({ path: 'InStorageRecordList', query:{ good_id: scope.row.id } })">入库记录</span>
                                <span class="fc-gray mal10 mar10">|</span>
                                <span class="fc-green2 pointer" @click="$router.push({ path: 'OutStorageRecordList', query:{ good_id: scope.row.id } })">出库记录</span>
                            </template>
                        </el-table-column>
...
<script>
    ...
    import { businessList, getList, getCatalogue } from '@/chain/assets/api/store/store'
    import { testMenu } from '@/chain/assets/api/common/common'
