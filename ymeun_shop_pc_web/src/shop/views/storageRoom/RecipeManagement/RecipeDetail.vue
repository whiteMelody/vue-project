...
<template>
    ...
    <div class="pal24 par24 pat20 pab20">
        <div class="bg-white pal20 par20">
            <p class="fc-gray4 f16px h40px lh40px">新增配方</p>
                    ...
                    <el-table slot="list" :data="item.list" border class="myTable">
                        ...
                        <el-table-column align="center">
                            <template slot="header" slot-scope="scope">
                                <el-button icon="el-icon-plus" @click="addCommodity(index)"></el-button>
                            </template>
                            <template slot-scope="scope">
                                <el-button icon="el-icon-minus" @click="removeCommodity(scope.$index, index)"></el-button>
                            </template>
                        </el-table-column>
...
<script>
    ...
    import { getList, formulaAdd, getFormulaEdit, formulaEdit, } from '@/shop/assets/api/recipe/recipe'
