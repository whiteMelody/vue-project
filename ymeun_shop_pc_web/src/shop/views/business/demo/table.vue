        ...
        >
          ...
          >
            ...
            <el-form-item :label="'选择'+$store.getters.roleName.adviser">
              <el-select v-model="condition.select" :placeholder="'选择'+$store.getters.roleName.adviser" readonly clearable>
                <el-option
            ...
            <el-form-item :label="'输入'+$store.getters.roleName.adviser">
              <auto-search-counselor
                v-model.trim="condition['counselor_id']"
                :placeholder="'请输入'+$store.getters.roleName.adviser"
                @matchRecord="v=>{condition.counselor_id=v.key}"
                :initValue="counselorName"
                clearable
              ></auto-search-counselor>
            </el-form-item>
            <el-form-item label="输入客户">
              <auto-search-client
...
<script>
import { getConsumeList } from "@/shop/assets/api/demo/demo";
