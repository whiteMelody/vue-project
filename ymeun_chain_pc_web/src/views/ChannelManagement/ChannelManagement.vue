        ...
        <div class="wb100">
                ...
                <el-table-column align="center" label="操作">
                  <template slot-scope="scope">
                    <p v-if="scope.row.items">
                      <span class="pointer buttonStyle_class"  @click="handleDialogFormOpen(false, scope.row)"><i class="iconfont icontianjia fc-green2"></i>添加下级类目</span>
                    ...
                    <p v-else>
                      ...
                      <!-- <template v-else>
                        <span class="pointer fc-green4" @click="open(scope.row,0)">
          ...
          <el-dialog :title="isEdit ? '修改大类' : '添加大类'" :visible.sync="dialogEditCategories" width="600px">
            <el-form :model="dialogEditCategoriesParam">
              ...
              <el-form-item label>
                <el-select class="wb100" v-model="dialogEditCategoriesParam.is_store" placeholder="请选择种类" clearable>
