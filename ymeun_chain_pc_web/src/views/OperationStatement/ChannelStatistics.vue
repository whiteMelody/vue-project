        ...
        <div class="wb100">
            ...
            <div class="wb100">
                ...
                <div class="pa20 bg-pink2 text-center f16px">
                    ...
                    <div class="wb10 fl">
                        <p class="fc-gray2 h20px lh20px">新增人头（人）</p>
                        <div class="clear2"></div>
                        <p class="fc-gray3 f20px h40px lh40px">{{info.quantity}}</p>
                    </div>
                    <div class="wb10 fl">
                        <p class="fc-gray2 h20px lh20px">留电</p>
                        <div class="clear2"></div>
                        <p class="fc-gray3 f20px h40px lh40px">{{info.phone}}</p>
                    </div>
                    <div class="wb10 fl">
                        <p class="fc-gray2 h20px lh20px">留电率</p>
                        <div class="clear2"></div>
                        <p class="fc-gray3 f20px h40px lh40px ">{{info.rate}}</p>
                    </div>
                    <div class="wb10 fl">
                        <p class="fc-gray2 h20px lh20px">预约人头（人）</p>
                        <div class="clear2"></div>
                        <p class="fc-gray3 f20px h40px lh40px text-over-hidden1">{{info.appointment }}</p>
                    </div>
                    <div class="wb13 fl">
                    ...
                    <div class="wb13 fl">
                        <p class="fc-gray2 h20px lh20px">退款金额（元）</p>
                        <div class="clear2"></div>
                    ...
                    <div class="wb13 fl">
                        ...
                        <div class="clear2"></div>
                        <p class="fc-gray3 f20px h40px lh40px text-over-hidden1">{{info.actual | _filterNumFormat }}</p>
                    </div>
...
<script>
    ...
    import { getStatistics } from "@/assets/api/manage/statistics"
