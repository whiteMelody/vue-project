<template>
    ...
    <div class="wb100 f14px bg-white1">
        <div class="pal24 par24 pat20 pab20">
            <div class="pal19 par19 pat20 bg-white">
                ...
                <div class="wb100">
                    ...
                    <el-form ref="form" label-width="100px">
                        <template v-for="item in list">
                            <div class="wb25 fl">
                                <el-form-item :label="item.name" prop="discount" style="white-space: nowrap">
            ...
            save(){
                ...
                membersDiscountByAll({
                    ...
                    if(res.status == 0){
                        this.$message({
                            showClose: true,
                            message: `${$store.getters.roleName.technician}折扣设置成功`,
                            type: 'success',
                            onClose:()=>{
                                this.$router.go(-1)
                                this.disabled = false
