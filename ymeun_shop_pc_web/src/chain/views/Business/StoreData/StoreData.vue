<template>
  ...
  <div class="wb100">
    ...
    <div class="pal18 par18 bg-white">
      <div class="wb30 h40px lh40px fl f18px">
        {{arrs[ arrs.length - 5 + curIndex ]}}数据
      </div>

      <div class="wb70 fr text-center F16rem mat5 relative">
        <div class=" relative fr">
          <template v-for="(item,index) in arrs">
            <template v-if="index == curIndex">
              <div class="w70px fr bg-green fc-white h28px lh28px mar10 mal10 pointer" @click="changeIndex(index)">{{item}}</div>
            </template>
            <template v-else>
              <div class="w70px fr fc-gray3 h28px lh28px mar10 mal10 pointer" @click="changeIndex(index)">{{item}}</div>
            </template>
            <div class="w15px fr h30px mat5 text-center fc-gray1" v-if="index != 4">|</div>
          </template>
        </div>
      </div>
        ...
        <div class="wb30 fl">
          <div class="wb100">
            <div class="wb100 h365px bg-white relative radius4">
              <img src="@/chain/assets/images/bor-lt.png" class="absolute" style="top:0; left: 0;">
              <img src="@/chain/assets/images/bor-br.png" class="absolute" style="right:0; bottom: 0;">
              <!--    柱状图    -->
        ...
        <div class="wb40 fl">
          <div class="pal20 par20">
            <div class="wb100 h365px bg-white relative radius4">
              <div class="pal20 par20 h365px" :style="'background: url('+bgGrid+') center center'">
                ...
                <div class="wb60 fl">
                  ...
                  <div class="w260px h260px center mat40 relative" :style="'background: url('+bgO+'); background-size: 100% 100%'">
                    ...
                    <img src="@/chain/assets/images/img-shan.png" class="rotate_img absolute" style="top:0; left: 0;">
                ...
                <div class="wb40 fr">
                  ...
                  <div class="wb100">
                    <img src="@/chain/assets/images/img-101.png" class="fl ma10">
                    <div class="fl lh25px">
                      <p>划扣总业绩（元）</p>
                  ...
                  <div class="clear0 h80px"></div>
                  <div class="wb100"> <img src="@/chain/assets/images/img-102.png" class="fl ma10">
                    <div class="fl lh25px">
                      <p>销售总业绩（元）</p>
              ...
              <img src="@/chain/assets/images/bor-lt.png" class="absolute" style="top:0; left: 0;">
              <img src="@/chain/assets/images/bor-br.png" class="absolute" style="right:0; bottom: 0;">
              <img src="@/chain/assets/images/bor-bl.png" class="absolute" style="left:0; bottom: 0;">
              <img src="@/chain/assets/images/bor-tr.png" class="absolute" style="right:0; top: 0;">
              <!--    柱状图    -->
              <div class="clear0"></div>
            </div>
          </div>
            ...
            <div class="wb100 h365px bg-white  relative radius4">
              ...
              <div class="pa20">
                ...
                <div class="wb100 h300px center relative">
                  ...
                  <div class="o1">
                    <!-- <img src="@/chain/assets/images/img-o1.png" class="roundness1 absolute" style="z-index: 2; top:0; left: 0; right: 0; bottom: 0; margin: auto; ">
                    <img src="@/chain/assets/images/img-o2.png" class="roundness2 absolute" style="z-index: 2; top:0; left: 0; right: 0; bottom: 0; margin: auto; ">
                    <img src="@/chain/assets/images/img-o3.png" class="roundness3 absolute" style="z-index: 2; top:0; left: 0; right: 0; bottom: 0; margin: auto; ">
                    <img src="@/chain/assets/images/img-o4.png" class="roundness4 absolute" style="z-index: 2; top:0; left: 0; right: 0; bottom: 0; margin: auto; "> -->
                    <img :src="imgArr" class="roundness5 absolute" style="z-index: 2; top:0; left: 0; right: 0; bottom: 0; margin: auto; ">
                  </div>

  <!--                <img src="@/chain/assets/images/img-100.png" class="absolute w60px" style="z-index: 2; top:0; left: 0; right: 0; bottom: 0; margin: auto; ">-->
      ...
      <div class="wb100">
        ...
        <div class="wb50 fl">
          <div class="par10">
            <div class="wb100 bg-white h500px">
...
<script>
  import { enterpriseOverview, managementData,getOrderRankingListByStore,getOrdersData,getConsumeData } from "@/chain/assets/api/StoreData/StoreData";
  ...
  import bgGrid from '@/chain/assets/images/bg-grid.png'
  import bgTitle from '@/chain/assets/images/bg-title.png'
  import bgO from '@/chain/assets/images/bg-o.png'

  import imgO5 from '@/chain/assets/images/img-o5.png'
  import imgO6 from '@/chain/assets/images/img-o6.png'
  import imgO7 from '@/chain/assets/images/img-o7.png'
