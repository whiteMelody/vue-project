...
<template>
    ...
    <div class="pal24 par24 pat20 pab20">
        <div class="bg-white pal20 par20">
            <p class="fc-gray4 f16px h40px lh40px">门店请货表</p>
            ...
            <div class="wb100">
                ...
                <base-list :condition="condition" ref="myList"
                    ...
                    <el-table slot="list" :data="demoList" border
                        ...
                        <el-table-column align="center" label="请货门店">
                            <template slot-scope="scope">
                        ...
                        <el-table-column align="center" label="采购计划" width="100px">
                            <template slot-scope="scope">
                        ...
                        <el-table-column align="center" label="操作" width="120px">
                            <template slot-scope="scope">
                                <span class="fc-blue6 pointer" @click="$router.push({ path: 'StorePleaseGoodsDetail', query:{ shortage_id: scope.row.id } })">查看详情</span>
                            </template>
                        </el-table-column>
...
<script>
    ...
    import { getShortageList } from '@/shop/assets/api/pleaseGoods/pleaseGoods'

    import { purchaseAdd, purchaseGetInfo } from '@/shop/assets/api/purchase/purchase'
