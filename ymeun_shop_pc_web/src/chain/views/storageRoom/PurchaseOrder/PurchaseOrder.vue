...
<template>
    ...
    <div class="pal24 par24 pat20 pab20">
        <div class="bg-white pal20 par20">
            <p class="fc-gray4 f14px h40px lh40px">{{pageTitle}}</p>
        ...
        <div class="bg-white pal20 par20">
            ...
            <div class="wb100">
                ...
                <el-form ref="form" :inline="true" :rules="rules" :model="form">
                    <el-form-item label="供应商" prop="business_id">
                        <el-select placeholder="全部供应商" v-model="form.business_id" :disabled="isEdit">
            ...
            <el-table slot="list" :data="demoList" border class="myTable">
                ...
                <el-table-column align="left" label="备注">
                    <template slot-scope="scope">
                        <el-input :disabled="isEdit" class="wb100" v-model="scope.row.remarks" placeholder="请输入采购备注"></el-input>
                    </template>
                </el-table-column>

                <el-table-column align="left" v-if="!isEdit">
            ...
            <template v-if="status === 0 || status === 1">
                 <el-button type="primary" class="fr minW100" @click="deriveExcel">导出Excel</el-button>
            </template>

            <template v-else-if="status === 2">
                <el-button type="primary" class="fr minW100" @click="$router.push({ path: 'InStorageOrderList',  query:{ orderId: orderId } })">订单入库</el-button>
                <el-button class="fr mal20 mar20 minW100" @click="deriveExcel">导出Excel</el-button>
            </template>
            ...
            <template v-else-if="status === 3">
                ...
                <template v-else>
                    <el-button type="primary" class="fr minW100" @click="submit">再次申请</el-button>
                </template>
            ...
            <template v-else>
                ...
                <template v-else>
                    <el-button type="primary" class="fr minW100" @click="submit">提交审核</el-button>
                </template>
                <el-button class="fr mal20 mar20 minW100" @click="back">取消</el-button>
            </template>
        ...
        methods: {
            ...
            deriveExcel() {
                this.$postRequest("/post/api/getUserInfo").then(res => {
                    ...
                    url += `?downloadUserId=${res.data.users_id}&orderId=${this.orderId}`;
