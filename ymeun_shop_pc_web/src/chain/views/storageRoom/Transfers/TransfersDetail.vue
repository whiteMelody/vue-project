        ...
        <template v-if="isEdit">
            <div class="pal24 par24 pat20 pab20">
                ...
                <div class="bg-white pal20 par20">
                    <p class="fc-gray4 f14px h40px lh40px">调拨出库订单详情</p>
                    ...
                    <div class="wb100 f14px">
                        ...
                        <span class="fl bd-gray bd-b1 mar10">{{dataInfo.allocation.users.name}}</span>
                        <span class="fl mal20">请货门店：</span>
                        <span class="fl bd-gray bd-b1 mar10">{{dataInfo.allocation.demand_store.name}}</span>
                        <span class="fl mal20">出库类别：</span>
                        <span class="fl bd-gray bd-b1 mar10">调拨出库</span>
                    </div>
...
<!--                    <el-button class="fr mal50 mar50 w100px" @click="back">返回</el-button>-->
        ...
        <template v-else>
            <div class="pal24 par24 pat20 pab20">
                <div class="bg-white pal20 par20">
                    <p class="fc-gray4 f14px h40px lh40px">调拨出库制单</p>
                    ...
                    <div class="wb100 f14px">
                        <div class="wb100 f14px">
                            ...
                            <span class="fl mal20">制单人：</span>
                            <span class="fl bd-gray bd-b1 mar10">{{$store.getters.currentUser.name}}</span>
                            <span class="fl mal20">出库类别：</span>
                            <span class="fl bd-gray bd-b1 mar10">调拨出库</span>
                            <span class="fl mal20 mar10">要货门店</span>
                            <el-select class="fl" style="margin-top: -10px" v-model="form.demandStoreId" placeholder="选择全部要货门店" readonly="" clearable>
                ...
                <div class="bg-white pal20 par20">
                    ...
                    <div class="pal20 par20 h34px lh34px bd-gray bd-b1 bd-l1 bd-r1 f14px">
                        ...
                        <span class="fr fc-gray3">出库数量：{{sumQuantity}}</span>
                    </div>

                    <div class="clear2"></div>

                    <el-input type="textarea" v-model="form.remarks" class="wb100" placeholder="请输入调货备注"></el-input>
...
<script>
    ...
    import { allocationAdd, getAllocationDetails } from '@/chain/assets/api/transfers/transfers'
