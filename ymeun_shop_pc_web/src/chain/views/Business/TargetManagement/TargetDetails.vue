  ...
  <div class="TargetDetails" :style="'min-height: '+boxMaxHeight+'px;'">
    ...
    <div class="box">
          ...
          <el-form :inline="true" :model="condition" class="search-form" slot="search" label-width="80px">
              ...
              <el-form-item>
                <el-button icon="el-icon-search" type="primary" class="h32px" @click="loadData"></el-button>
              </el-form-item>

              <el-form-item>
                <el-button type="primary" @click="getSetUp">保存设置</el-button>
              </el-form-item>
...
<script>
import { getList,getTime,getSave } from "@/chain/assets/api/targetManagement/targetDetails";
