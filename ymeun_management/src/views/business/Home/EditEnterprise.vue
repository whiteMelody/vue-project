              ...
              <el-form :inline="true" ref="form" :model="form" :rules="rules" label-width="140px">
                  ...
                  <div class="wb100">
                      <el-form-item label="企业简称" prop="abbreviation">
                          <el-input type="text" v-model.trim="form.abbreviation" readonly disabled placeholder="请输入企业简称" clearable></el-input>
                      </el-form-item>
                  </div>
...
<script>
    ...
    import { enterpriseEdit } from "@/assets/api/home/home"
