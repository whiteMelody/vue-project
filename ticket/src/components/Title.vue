<template>
  ...
  <div class="wb100" v-if="showTitle">
    <div class="wb100 h50px warpper-black-5" :class="fixed ? 'fixed' : 'relative'" style="z-index: 99999;">
...
<script>
    ...
    export default{
        props: ['title', 'back_url', 'back', 'fixed',],
        data (){
            return {
                showTitle: true,
            }
        ...
        mounted(){
          ...
          if(_source != 'wap') this.showTitle = false
          //判断微信内核
          if(Base.versions.isWeiXin)  this.showTitle = false
        }
    }
</script>
