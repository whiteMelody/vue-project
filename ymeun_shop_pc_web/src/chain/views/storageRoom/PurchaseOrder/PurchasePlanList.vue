...
<template>
    ...
    <div class="pal24 par24 pat20 pab20">
        <div class="bg-white pal20 par20">
            <p class="fc-gray4 f14px h40px lh40px">采购计划列表</p>
            ...
            <base-list :condition="condition" ref="myList"
                ...
                <el-table slot="list" :data="demoList" border>
                    ...
                    <el-table-column align="left" label="操作" width="120px">
                        <template slot-scope="scope">
                            <span class="fc-green2 pointer" @click="$router.push({ path: 'PurchasePlanDetail', query:{ purchase_id: scope.row.id } })">查看详情</span>
                        </template>
                    </el-table-column>
...
<script>
    ...
    import { purchaseList } from '@/chain/assets/api/purchase/purchase'
