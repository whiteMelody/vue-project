<template>
  <div class="wb100">
    <!-- <p class="lh50px h50px">
            <span class="fl f16px fc-gray4">美容师销售报表</span>
    ...
    <div class="wb100">
      <div class="wb100">
        ...
        <!--
                <div class="pa20 bg-blue5 text-center bd-blue4 bd-a1 f16px">
                    ...
                    <div class="wb16 mar3per fl h40px lh40px bd-gray bd-r1 mat15">
                     ...
                     <div class="wb10 fl">
                        <p class="fc-gray3 h20px lh20px">铺垫人次（次）</p>
                        <div class="clear2"></div>
                        <p class="fc-blue6 f12px h40px lh40px">{{info.paveCustomer}}</p>
                    </div>
                    <div class="wb10 fl">
                    ...
                    <div class="wb15 fl">
                        ...
                        <div class="clear2"></div>
                        <p class="fc-blue6 f20px h40px lh40px">{{info.order | _filterNumFormat }}</p>
                    </div>
                    <div class="wb15 fl">
                        <p class="fc-gray3 h20px lh20px">退单金额（元）</p>
                        <div class="clear2"></div>
                        <p class="fc-blue6 f20px h40px lh40px">{{info.refund | _filterNumFormat }}</p>
                    </div>
                     <div class="wb12 fl">
                        <p class="fc-gray3 h20px lh20px">券额（元）</p>
                        <div class="clear2"></div>
                        <p class="fc-blue6 f12px h40px lh40px">{{info.givePrice | _filterNumFormat }}</p>
                    </div> 
                    <div class="wb15 fl">
                        <p class="fc-gray3 h20px lh20px">欠款金额（元）</p>
                        <div class="clear2"></div>
                        <p class="fc-blue6 f20px h40px lh40px">{{info.arrears_price | _filterNumFormat }}</p>
                    </div>
                    <div class="wb15 fl">
                    ...
                    <div class="wb15 fl">
                        ...
                        <div class="clear2"></div>
                        <p class="fc-blue6 f20px h40px lh40px">{{info.performance | _filterNumFormat }}</p>
                    </div>
        ...
        <div class="market_total">
          <div>{{$store.getters.roleName.technician}}销售业绩合计</div>
          <em></em>
          <ul>
            <li>
              <p>销售业绩(元)</p>
        ...
        >
          <el-table slot="list" :data="demoList" stripe border>
            <el-table-column prop="usersName" align="center" :label="$store.getters.roleName.technician">
              <template slot-scope="scope">{{scope.row.usersName}}</template>
            </el-table-column>

            <!-- <el-table-column prop="paveCustomer" align="center" label="铺垫人次（次）">
                            <template slot-scope="scope">
                                {{ scope.row.paveCustomer }}
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="dealCustomer" align="center" label="成交人头（人）">
                            <template slot-scope="scope">
                                {{ scope.row.dealCustomer }}
                            </template>
            </el-table-column>-->
            ...
            <el-table-column prop="surplus" align="center" label="实际业绩（元）">
...
<script>
import { technicianPerformance } from "@/shop/assets/api/manage/statistics";
...
export default {
  ...
  data() {
    return {
      ...
      // condition: {},                              // 查询条件
      demoList: [], // table数组
      pageSearch: technicianPerformance, // 分页查询api接口
      info: {},
      isHideEmpty: false
    };
  },
  ...
  methods: {
    ...
    deriveExcel() {
      ...
      if (window.location.hostname == this.$base.getStoreHost()) {
        url = `https://${
          location.hostname
        }/post/export/analysis/technicianGetPrintInfo`;
      } else {
