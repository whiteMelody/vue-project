     ...
     <div class="wb100">
            ...
            <div class="wb100">
                ...
                <div class="pa20 bg-blue5 text-center bd-blue4 bd-a1 f16px">
                    ...
                    <div class="wb15 fl">        
                        <p class="fc-gray3 h20px lh20px">未划扣总次数（次）</p>
                        <div class="clear2"></div>
                        <p class="fc-blue6 f20px h40px lh40px text-over-hidden1">{{info.number }}</p>
                    </div>
                    <div class="wb15 fl">
                        <p class="fc-gray3 h20px lh20px">总未划扣金额（元）</p>
                        <div class="clear2"></div>
                        <p class="fc-blue6 f20px h40px lh40px text-over-hidden1">{{info.price | _filterNumFormat }}</p>
                    </div>
                    ...
                    <el-table slot="list" :data="demoList" stripe border>
                        ...
                        <el-table-column align="center" label="客户姓名">
                            <template slot-scope="scope">
                              <el-link :underline="false" @click="$router.push({name:'ClientDel',query:{id:scope.row.id}})">{{ scope.row.name}}</el-link>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="store_time" align="center" label="未划扣次数（次）" width="200px">
                            <template slot-scope="scope">
                                <template v-for="(item,index) in scope.row.items">
                        ...
                        <el-table-column prop="store_time" align="center" label="未划扣金额(元)" width="200px">
                            <template slot-scope="scope">
                                <template v-for="(item,index) in scope.row.items">
                        ...
                        <el-table-column prop="store_time" align="center" label="未划扣总次数(次)" width="150px">
                            <template slot-scope="scope">{{ scope.row.number}}</template>
                        </el-table-column>
                        <el-table-column prop="store_time" align="center" label="总未划扣金额(元)" width="150px">
