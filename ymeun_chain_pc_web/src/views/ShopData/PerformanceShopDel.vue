      ...
      <div class="shop_data" v-loading="loading">
        <div class="shop_data_left">
          ...
          <div class="shop_data_box">
            ...
            <div class="market box1">
              ...
              <div class="icon"><img src="../../assets/images/icon_a6.png" alt=""></div>
            </div>
            <div class="deduct box1">
              ...
              <div class="icon"><img src="../../assets/images/icon_a5.png" alt=""></div>
            </div>
        ...
        <div class="shop_data_right">
          <div class="shop_data_right_box">
            ...
            <div class="icon"><img src="../../assets/images/icon_a4.png" alt=""></div>
          </div>
        </div>
          ...
          <template v-if="listTitleIndex == 0">
            <div class="wb100 text-center fc-gray4 bd-gray bd-a1 relative">
                    ...
                    <p class="pal20 text-left el-cursor" @click="tabIndex = 0">销售业绩(元)
                      <el-tooltip placement="bottom-start" effect="light"> 
                        <template slot="content">
                          <span>点击查看 <font color='#FF5722'>销售业绩</font> 排名</span>
                        </template>
                        <i class="icon iconfont iconpaixu-copy fr par10 f20px lh38px fc-gray2 el-cursor" @click="tabIndex = 0"></i>
                      </el-tooltip>
                    </p>
                  </div>
                </div>
                ...
                <div class="wb14 fl">
                  <div class="wb100 h43px bd-b1 bd-r1 bd-gray">
                    <p class="pal20 text-left el-cursor" @click="tabIndex = 1">划扣人头(人)
                      <el-tooltip placement="bottom-start" effect="light"> 
                        <template slot="content">
                          <span>点击查看 <font color='#FF5722'>划扣人头</font> 排名</span>
                        </template>
                        <i class="icon iconfont iconpaixu-copy fr par10 f20px lh38px fc-gray2 el-cursor"></i>
                      </el-tooltip>
                    </p>
                  </div>
                </div>
                <div class="wb14 fl">
                  <div class="wb100 h43px bd-b1 bd-r1 bd-gray">
                    <p class="pal20 text-left el-cursor" @click="tabIndex = 2">划扣人次(次)
                      <el-tooltip placement="bottom-start" effect="light"> 
                        <template slot="content">
                          <span>点击查看 <font color='#FF5722'>划扣人次</font> 排名</span>
                        </template>
                        <i class="icon iconfont iconpaixu-copy fr par10 f20px lh38px fc-gray2 el-cursor"></i>
                      </el-tooltip>
                    </p>
                ...
                <div class="wb14 fl">
                  <div class="wb100 h43px bd-b1 bd-r1 bd-gray">
                    <p class="pal20 text-left el-cursor" @click="tabIndex = 3">成交人头(人)
                      <el-tooltip placement="bottom-start" effect="light"> 
                        <template slot="content">
                          <span>点击查看 <font color='#FF5722'>成交人头</font> 排名</span>
                        </template>
                        <i class="icon iconfont iconpaixu-copy fr par10 f20px lh38px fc-gray2 el-cursor"></i>
                      </el-tooltip>
                    </p>
                ...
                <div class="wb14 fl">
                  <div class="wb100 h43px bd-b1 bd-r1 bd-gray">
                    <p class="pal20 text-left el-cursor" @click="tabIndex = 4">成交人次(次)
                      <el-tooltip placement="bottom-start" effect="light"> 
                        <template slot="content">
                          <span>点击查看 <font color='#FF5722'>成交人次</font> 排名</span>
                        </template>
                        <i class="icon iconfont iconpaixu-copy fr par10 f20px lh38px fc-gray2 el-cursor"></i>
                      </el-tooltip>
                    </p>
              ...
              <template v-for="(item, index) in list">
                ...
                <div class="wb13 fl h120px lh120px">
                  <div class="wb100 h120px bd-b1 bd-r1 bd-gray">{{item.role_id == 3 ? '顾问' : '美容师'}}</div>
                </div>
                ...
                <div class="wb12 fl">
                  <div class="wb100 h43px bd-b1 bd-r1 bd-gray">
                    <p class="pal20 text-left el-cursor" @click="tabIndex = 3">划扣业绩(元)
                      <el-tooltip placement="bottom-start" effect="light"> 
                        <template slot="content">
                          <span>点击查看 <font color='#FF5722'>划扣业绩</font> 排名</span>
                        </template>
                        <i class="icon iconfont iconpaixu-copy fr par10 f20px lh38px fc-gray2 el-cursor"></i>
                      </el-tooltip>
                    </p>
...
<script>
import { getStore , getTime , getTargetList, consumeSurplus } from '@/assets/api/shopData/shopData'
export default {
