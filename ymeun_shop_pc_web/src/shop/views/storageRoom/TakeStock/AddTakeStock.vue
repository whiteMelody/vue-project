...
<template>
  <div class="AddTakeStock">
    <header>
      ...
      <div>
        <el-button type="primary" class="h32px" @click="clonePageFn"
...
<script>
import { inventoryAdd , getInventoryDetails , checkIsCompleteInventory , inventoryClose , inventoryOpen } from "@/shop/assets/api/takeStock/takeStock"
export default {
  name: "AddTakeStock",
  data() {
    return {
