...
<script>
    ...
    export default {
        ...
        data() {
            return {
                action: 'http://222.182.202.11:5722/post/item/itemExcelImport',
                headers: {
        ...
        methods: {
            ...
            uploadSectionFile(param) {
                ...
                // 接收上传文件的后台地址
                let FileController = "http://222.182.202.11:5722/post/item/itemExcelImport";
                // FormData 对象
                ...
                xhr.onload = () => {
                    ...
                    this.attachments.push("http://222.182.202.11:5722/post/item/itemExcelImport" + res.data)
