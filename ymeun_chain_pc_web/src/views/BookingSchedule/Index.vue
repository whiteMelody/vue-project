<template>
  <div class="bookingSchedule wb100 f14px mat10">
    <div class="bg-white pat18 pal18 bd-gray bd-b1">
      <el-form :inline="true" :model="condition" class="search-form" slot="search" label-width="80px">
          ...
          <el-button type="primary" @click="appointmentSchedulingFn" class="h32px">搜索</el-button>
      </el-form>
    </div>
    ...
    <el-dialog :title="getDate + ' 预约排期'" :visible.sync="dialogTableVisible" width="70%">
      <el-table :data="gridData" style="max-height:500px;overflow-y: auto;">
        ...
        <el-table-column property="adviser_name" label="顾问" width="150"></el-table-column>
        <el-table-column property="technician_name" label="美容师" width="150"></el-table-column>
...
import { appointmentScheduling , getAppointmentList } from "@/assets/api/common/common"
export default {
