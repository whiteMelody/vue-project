<template>
  <div class="wb100">
    <p class="lh40px h40px">
      <span class="fl f14px fc-gray4">品项销售情况表</span>
      ...
      <div class="wb100">
        ...
        <div class="pal20 par20 pat20 bg-white4">
          ...
          <div class="w150px fl h40px lh15px mar20 mab20">
            ...
            <p class="Fb fc-gray4 f20px mat10">{{info.orders_amount | _filterNumFormat}}</p>
          </div>
          <div class="w150px fl h40px lh15px mar20 mab20">
            <p class="fc-gray2">退款总额（元）</p>
            <p class="Fb fc-gray4 f20px mat10">{{info.refund_amount | _filterNumFormat}}</p>
          </div>
          <div class="w150px fl h40px lh15px mar20 mab20">
            <p class="fc-gray2">欠款总额（元）</p>
            <p class="Fb fc-gray4 f20px mat10">{{info.arrears_amount | _filterNumFormat}}</p>
          </div>
          <div class="w150px fl h40px lh15px mar20 mab20">
            <p class="fc-gray2">实际金额（元）</p>
            <p class="Fb fc-gray4 f20px mat10">{{info.actual_amount | _filterNumFormat}}</p>
          </div>
          <div class="clear0"></div>
        </div>
        ...
        <div class="lh38px h40px pointer">
          <template v-if="showType == 0">
            <span class="fl fc-green2 f14px">品项销售情况表</span>
            <span class="fl f14px mal20 mar20 fc-gray"> | </span>
          ...
          <template v-else-if="showType == 1">
            <span class="fl fc-gray2 f14px pab2" @click="changeShowType(0)">品项销售情况表</span>
            <span class="fl f14px mal20 mar20 fc-gray"> | </span>
...
<script>
  ...
  import { getSale } from "@/chain/assets/api/manage/statistics"
