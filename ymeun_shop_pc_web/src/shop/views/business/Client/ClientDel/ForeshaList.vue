    ...
    <div class="box">
      ...
      >
        ...
        >
          ...
          <!-- <el-form-item>
             <el-select v-model="condition.technician_id" placeholder="选择美容师" readonly="" clearable>
        ...
        <el-table slot="list" :data="demoList" stripe border>
          ...
          <el-table-column align="center" label="操作">
            <template slot-scope="scope">
              <a class="buttonStyle_class" @click="$router.push({path:'/ForeshadowingFillIn',query:{taskId:scope.row.id,customerId:scope.row.customer_id}})">修改记录</a>
            </template>
          </el-table-column>
        </el-table>
      </base-list>
