  ...
  <div class="CooperativeEnterpriseList" :style="'min-height: '+boxMaxHeight+'px;'">
    ...
    <base-list ref="demoTable" :condition="condition"
      ...
      <el-table slot="list" :data="demoList" stripe border>
          ...
          <el-table-column prop="ratio" align="center" label="分成比例">
...
<script>
import { businessList , businessAdd , businessEdit } from "@/assets/api/cooperativeEnterprise/cooperativeEnterprise";
