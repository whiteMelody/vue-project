            ...
            <div class="wb100">
                ...
                <div class="pal20 par20 pat20 bg-white4">
                    ...
                    <div class="w150px fl h40px lh15px mar20 mab20">
                        ...
                        <p class="Fb fc-gray4 f20px mat10">{{info.consumePrice | _filterNumFormat }}</p>
                    </div>
                    <div class="w150px fl h40px lh15px mar20 mab20">
            ...
            deriveExcel() {
                this.$postRequest("/post/api/getUserInfo").then(res => {
                    ...
                    if(window.location.hostname == this.$base.getStoreHost()){
                        url = `https://${location.hostname}/post/export/member/technicianGetPrintInfo`;
                    }else{
                        url = `http://${location.hostname}:${location.port}/post/export/member/technicianGetPrintInfo`;
                    }
