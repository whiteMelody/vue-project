<template>
  <el-dialog :title="form.p_name" :visible.sync="dialogForm" width="1000px">
      ...
      <!--                      <el-select v-model="form.p_id" placeholder="下级名称" readonly clearable v-if="!isEdit" disabled="">-->
    ...
    <div class="pal20 par20">
      <el-form ref="myForm" :model="form" :rules="rules" label-width="100px">
          ...
          <div class="wb100">
              ...
              <div class="w300px fl">
                  <el-form-item label="品项属性" prop="fashion">
            ...
            <template v-if="form.style == 1">
                ...
                <template v-for="(item, index) in comboList">
                    ...
                    <div class="pat10 bg-white1">
                        <div class="w300px fl">
                            <el-form-item :label="'套餐'+(index + 1)+'信息'">
...
import { itemsList , itemsAdd , itemsChangeStatus, getListItems } from "@/shop/assets/api/projectManagement/projectManagement"
      ...
      return {
        ...
        rules: {
          ...
          name: [{required: true, message: '请输入项目名称', trigger: 'change'}],
            alias_name: [{required: true, message: '请输入项目简称', trigger: 'change'}],
      ...
      dialogForm(bool) {
        if (!bool) {
          ...
          this.isEdit = false
            ...
            // if(!this.isStore){
            //     // 项目
            //     getListItems({ itemParentId: 0, storeId: this.storeId, is_store_settings:1 }).then(res => {
            //         if(res.status == 0){
            //
            ...
            //     })
            // }else{
            //     getListItems({ itemParentId: -1 }).then(res => {
            //         if(res.status == 0){
            //
